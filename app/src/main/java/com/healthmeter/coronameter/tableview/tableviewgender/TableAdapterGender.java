...
public class TableAdapterGender extends AbstractTableAdapter<ColumnHeaderModel, RowHeaderModel,
        CellModel> {

    private TableViewModelGender tableViewModelGender;

    public TableAdapterGender(Context p_jContext) {
        super(p_jContext);

        this.tableViewModelGender = new TableViewModelGender();
    }
    ...
    public int getCellItemViewType(int position) {
        return tableViewModelGender.getCellItemViewType(position);
    }
     ...
     */
    public void setTableItemList(List<TableItemGender> tableItemGenderList) {
        // Generate the lists that are used to TableViewAdapter
        tableViewModelGender.generateListForTableView(tableItemGenderList);

        // Now we got what we need to show on TableView.
        setAllItems(tableViewModelGender.getColumHeaderModeList(), tableViewModelGender
                .getRowHeaderModelList(), tableViewModelGender.getCellModelList());
    }
