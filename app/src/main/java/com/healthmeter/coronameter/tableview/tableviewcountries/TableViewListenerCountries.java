...
public class TableViewListenerCountries implements ITableViewListener {
    private static final String LOG_TAG = TableViewListenerCountries.class.getSimpleName();

    private ITableView mTableView;

    public TableViewListenerCountries(ITableView pTableView) {
