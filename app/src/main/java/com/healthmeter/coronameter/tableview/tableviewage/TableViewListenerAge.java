...
public class TableViewListenerAge implements ITableViewListener {
    private static final String LOG_TAG = TableViewListenerAge.class.getSimpleName();

    private ITableView mTableView;

    public TableViewListenerAge(ITableView pTableView) {
