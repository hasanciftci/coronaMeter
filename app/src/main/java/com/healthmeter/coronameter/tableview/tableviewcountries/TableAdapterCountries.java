...
public class TableAdapterCountries extends AbstractTableAdapter<ColumnHeaderModel, RowHeaderModel,
        CellModel> {

    private TableViewModelCountries tableViewModelCountries;

    public TableAdapterCountries(Context p_jContext) {
        super(p_jContext);

        this.tableViewModelCountries = new TableViewModelCountries();
    }
    ...
    public int getCellItemViewType(int position) {
        return tableViewModelCountries.getCellItemViewType(position);
    }
     ...
     */
    public void setTableItemList(List<TableItemCountries> tableItemCountriesList) {
        // Generate the lists that are used to TableViewAdapter
        tableViewModelCountries.generateListForTableView(tableItemCountriesList);

        // Now we got what we need to show on TableView.
        setAllItems(tableViewModelCountries.getColumHeaderModeList(), tableViewModelCountries
                .getRowHeaderModelList(), tableViewModelCountries.getCellModelList());
    }
