...
public class TableViewListenerPreCon implements ITableViewListener {
    private static final String LOG_TAG = TableViewListenerPreCon.class.getSimpleName();

    private ITableView mTableView;

    public TableViewListenerPreCon(ITableView pTableView) {
